...
export const ArticleLock = props => {
  ...
  return (<div id='container' className="flex justify-center">
    <div className="overflow-x-auto max-w-5xl  w-screen md:w-full  py-10 px-5 lg:pt-24 md:px-24 min-h-screen dark:border-gray-700 duration-200 subpixel-antialiased">
